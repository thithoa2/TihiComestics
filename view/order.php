...
<!--Less styles -->
   <!-- Other Less css file //different less files has different color scheam
	...
	<link rel="stylesheet" type="text/css" href="../themes/css/css/style.css"/>
<link rel="stylesheet" type="text/css" href="../themes/css/css/reset.css"/>
<!-- Bootstrap style --> 
...
$sql = 'SELECT name_product as name, image_product as img, price_product as price, so_luong , sum(tong_tien) as tong_tien  FROM don_hang, product WHERE product.id_product = don_hang.id_product GROUP BY ma_don_hang';
$req = $conn->query($sql);
if ($req->num_rows > 0) {
?>
<table class="table table-bordered">
...
<?php
        ...
        {
            foreach($_SESSION['admin'] as $id =>$prd)
            {
                $arr_id[] = $id;
            }
    ...
    ?>
                ...
                <tr>
                  <td>
                  	...
                  	<?php echo $row['name'];  ?>
                  	<div class="delete_Cart"><a href="../index.html" class="del_sp">Bỏ sản phẩm</a></div>
                  	 </td>
